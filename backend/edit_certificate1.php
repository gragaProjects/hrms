  ...
  <div class="container-fluid">
   ...
   <?php $this->load->view('backend/footer'); ?>
    ...
    $('#add').click(function () {
        ...
        var newElement = $('<div class="col-12 mt-2"> <label class="">Annexure ' + i + '</label> <textarea id="' + newEditorId + '" class="mymce content" name="content[]"></textarea> <div class="tag-container" id="tag-container-' + newEditorId + '"></div><button type="button" name="remove" id="' + i + '" class="btn btn-danger btn_remove">Remove</button></div>');
