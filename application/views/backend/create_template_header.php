                        ...
                        <div class="form-group clearfix m-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <img id="header-preview" class="img-preview" alt="Header Preview" width="350px">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <img id="footer-preview" class="img-preview" alt="Footer Preview" width="350px">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <img id="watermark-preview" class="img-preview" alt="Watermark Preview" width="100px">
                                </div>
                            </div>
                        </div>
