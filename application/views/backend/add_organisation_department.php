...
<?php $this->load->view('backend/sidebar'); ?>
                                        ...
                                        <div class="form-group clearfix m-3">
                                           <div class="row"> 
                                            ...
                                            <div class="col-md-3">
                                                   ...
                                                   <div class="col-md-3">
                                                 <label for="title" class="">Department Name</label><span class="error"> *</span>
                                                <input type="text" class="form-control validate" name="depname"  id="depname" placeholder=""   style="text-transform: capitalize;" maxlength="120" required>
                                            </div>
                                                  <div class="col-md-3">
                                                 <label for="title" class="">Deparment Code</label><span class="error"> *</span>
                                                <input type="text" class="form-control validate" name="depcode" id="depcode" placeholder=""   maxlength="120" required>
                                            </div>
                                              <div class="col-md-3">
                                                <label class="">Department Head</label><span class="error"> *</span>
                                     ...
                                     <div class="form-group clearfix m-3">
                                          <div class="row">
                                               ...
                                               $newdate = date("Y-m-d", strtotime(isset($organisationvalue->startedon)));
                                                if(isset($newdate)){ ?> value="<?php //echo $newdate ?>" <?php }?>  id="startedon" required>
                                            </div>
                                             <div class="col-md-3">
                                                   <label for="description">Description</label>
                                                <textarea class="form-control validate" id="description"  name="description" rows="1" ></textarea>
                                            </div> 
                                               <div class="col-md-3">
                                            <label class="">Status</label><span class="error"> </span>
                                            <select name="status" id="status"  class="form-control custom-select search validate" style="width: 100%; min-height: 38px;" required>
    ...
    var busunit_id=$("#busunit_id").val();
    var depcode=$("#depcode").val();
    var dephead_id=$("#dephead_id").val();
   ...
   if(depname != '' && busunit_id != '' && depcode != ''  && dephead_id != ''  && startedon != '' && timezoneid != '' && country != '' && state != '' && city!= '' && address1 != ''){
   $.ajax({
    type:'post',
    url: '<?php echo base_url("settings/Save_Orgdepartment");?>',
