         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-user-secret" aria-hidden="true"></i>Shift Master</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <button type="button" class="btn btn-info" style="width: 140px;"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Shift/AddShiftMaster" class="text-white"><i class="" aria-hidden="true"></i> Add Shift</a></button>
                           <?php } ?>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                  <h4 class="m-b-0 text-white">&nbsp;&nbsp;<i class="fa fa-user-o" aria-hidden="true"></i>  Shift Master</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive ">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $value->night_shift; ?></td>
                                    
                                        <?php  if($this->role->User_Permission('Shift','can_edit')){?>
                                        <td class="jsgrid-align-center ">
                                            <input type="hidden" name="id"  id="id" value="<?php echo $value->id; ?>"/>
                                            <a href="<?php echo base_url(); ?>Shift/EditShiftMaster?I=<?php echo base64_encode($value->id); ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
...
<script type="text/javascript">
  ...
  $(document).on('click','#active',function(){
   ...
   // var inactivestatus = $(this).val();
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Settings/ShiftDelete') ?>',
    data: {id:id},
