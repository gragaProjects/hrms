         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-user-secret" aria-hidden="true"></i>Templates</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <button type="button" class="btn btn-info" style="width: ;"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Certificate/create_certificate" class="text-white"><i class="" aria-hidden="true"></i> Create Template </a></button>
                           <?php } ?>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                  <h4 class="m-b-0 text-white">&nbsp;&nbsp;<i class="fa fa-user-o" aria-hidden="true"></i>  Templates</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive ">
                                    ...
                                    <tr>
                                        ...
                                        <td class="jsgrid-align-center ">
                                            ...
                                            <a href="<?php echo base_url(); ?>Certificate/edit_certificate?I=<?php echo base64_encode($value->template_id); ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
                                             ...
                                             <!-- Appointment  -->
                                                    <a href="<?php echo base_url(); ?>Certificate/CertificatePdf?Id=<?php echo $value->id;?>&busunit=<?php echo $value->busunit;?>" title="<?php echo $value->title; ?> Letter" class="btn btn-sm btn-info waves-effect waves-light" target="_blank"><i class="fa fa-print"></i></a>
                                        </td>
                                         <?php }; ?>
                                    </tr>
                                    <?php $i++;
...
<script type="text/javascript">
  ...
  $(document).on('click','#active',function(){
   ...
   // var inactivestatus = $(this).val();
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Certificate/CertificateDelete') ?>',
    data: {id:id},
