...
<?php $this->load->view('backend/sidebar'); ?> 
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-cubes" style="color:#1976d2"></i>   Template Tag </h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <!-- <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active"> Template Tag </li> -->
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">         
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">
                                  <h4 class="m-b-0 text-white">&nbsp;&nbsp;Edit Template Tag </h4> 
                            </div>
                                ...
                                <!-- action="<?php echo base_url();?>organization/Update_dep" -->
                                    <form method="post" id="edittypeform"  enctype="multipart/form-data">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="control-label">  Tag Name<span class="error"> * </span> <small>Ex:  {tag_name}</small></label>
                                                       <input type="text" name="category" id="category" value="<?php  echo $typevalue_edit->name?>" class="form-control" placeholder="">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a style="float:right;" href="<?php echo base_url();?>Certificate/CreateTags" class="btn btn-rounded btn-info">Add New</a>
                                        </div>
                                    </form>
                            </div>
                        </div>
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">
                                  <h4 class="m-b-0 text-white">&nbsp;&nbsp;Add Template Tag </h4>
                            </div>
                    ...
                    <div class="col-7">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                  <h4 class="m-b-0 text-white">&nbsp;&nbsp;Template Tag List</h4>
                            </div>         
                            <div class="card-body">
                                               ...
                                               <td><?php echo $i; ?></td>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                   <!--  <a href="" title="Edit" class="btn btn-sm btn-info waves-effect waves-light TypeModal" data-id="<?php echo $value->id; ?>"><i class="fa fa-pencil-square-o"></i></a> -->
                                                      <a href="<?php echo base_url();?>Certificate/EditTags/<?php echo $value->id;?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light">
   ...
   $(document).on('click','#add_category',function(){
    ...
    $.ajax({
    type:'post',
    url: '<?php echo base_url("Certificate/Add_Tags");?>',
    ...
    $.ajax({
    type:'post',
    url: '<?php echo base_url("Certificate/Update_Tags");?>',
   ...
   //delete
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Certificate/Delete_tag') ?>',
    data: {id:id},
