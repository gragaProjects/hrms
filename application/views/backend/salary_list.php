                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                 ...
                                 <?php if($this->role->User_Permission('payroll_list','can_view') && $this->role->User_Permission('payroll_list','can_delete') && $this->role->User_Permission('generate_payslip','can_add') && $this->role->User_Permission('generate_payslip','can_edit')){?>
                                        <tbody>
                                           ...
                                           <?php $i =1; foreach($salary_info as $individual_info): ?>
                                            <tr>
                                              ...
                                              <td><?php echo $individual_info->addition; ?></td>
                                                ...
                                                <td><?php if($individual_info->paid_date){
                                                echo date('d M Y',strtotime($individual_info->paid_date)); }  ?></td>
                                              ...
                                              <a href="<?php echo base_url(); ?>Payroll/Pdf?Id=<?php echo $individual_info->pay_id; ?>&em=<?php echo $individual_info->emp_id;?>" title="Payslip" class="btn btn-sm btn-info waves-effect waves-light" target="_blank"><i class="fa fa-print"></i></a>
                                              <?php if($this->role->User_Permission('payroll_list','can_delete')   ){?>
                                              <button   title="Delete"class="btn btn-sm btn-info waves-effect waves-light payslipdel" data-id="<?php echo $individual_info->pay_id; ?>"><i class="fa fa-trash-o"></i></button> 
                                               <?php } ?>
                                                </td>
                                        ...
                                        <?php }elseif ($this->role->User_Permission('payroll_list','can_view')) {
                                            $id = $this->session->userdata('user_login_id');
                                         $payrollinfo = $this->payroll_model->getempSalaryData($id);
                                        ...
                                        <tbody>
                                           ...
                                           foreach($payrollinfo as $data): ?>
                                            <tr>
                                              ...
                                              <td><?php echo $data->addition; ?></td>
                                                <td><?php echo $data->diduction; ?></td>
                                                <td><?php echo $data->total_pay; ?></td>
                                                <td><?php  if($individual_info->paid_date){
                                                echo date('d M Y',strtotime($data->paid_date)); } ?></td>
                                                <td><?php echo $data->status; ?></td>
                                                <td class="jsgrid-align-center ">
                                                    <!-- <a href="<?php echo base_url(); ?>payroll/invoice?Id=<?php echo $data->pay_id; ?>&em=<?php echo $data->emp_id; ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-print"></i></a> --> 
                                              <a href="<?php echo base_url(); ?>Payroll/Pdf?Id=<?php echo $data->pay_id; ?>&em=<?php echo $data->emp_id;?>" title="view payslip" class="btn btn-sm btn-info waves-effect waves-light" target="_blank"><i class="fa fa-print"></i></a>
                                              <?php if($this->role->User_Permission('payroll_list','can_delete')   ){?>
                                              <button   title="Delete"class="btn btn-sm btn-info waves-effect waves-light payslipdel" data-id="<?php echo $data->pay_id; ?>"><i class="fa fa-trash-o"></i></button> 
                                               <?php } ?>
                                                </td>
                                            </tr>
                                            <?php  $i++; endforeach; ?>
...
<script>
    ...
    //delete
    $(document).on('click','.payslipdel', function (e) {
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Payroll/Payslipdelete') ?>',
    data: {id:id},
