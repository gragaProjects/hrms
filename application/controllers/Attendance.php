...
class Attendance extends CI_Controller
{
    ...
    public function Get_attendance_data_for_report()
    {
        if ($this->session->userdata('user_login_access') != False) {
            ...
            $employee_PIN = $this->getPINFromID($employee_id)->em_id;
                ...
                if (empty($id)) {
                    ...
                    if($day == "Fri") {
                        ...
                        if(!empty($duplicate)){
                             ...
                             echo json_encode(array('status'=>'error','message'=>'Already Exist'));
                        } else {
                      ...
                      /*  $data = array(
                       ...
                       if($success){
                        ...
                        if(!empty($duplicate)){
                           ...
                           $success = $this->attendance_model->Update_AttendanceData($id, $data);
                            ///echo "Successfully Updated.";
                             if($success){
    ...
    function import()
    {
        ...
        foreach ($file_data as $row){
            ...
            $success[] = $this->attendance_model->bulk_Update($row["Employee No"],$date,$data);
            ...
            $data = array(
                ...
                'place' => 'office'
                    ...
                    //echo count($data); 
        $addsuccess[] = $this->attendance_model->Add_AttendanceData($data); 
